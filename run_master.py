...
def main(config):
    ...
    master = misc.utility.get_es_master(
        ...
        start_iter=config.restore_iter,
        load_model_path=config.restore_model
    )
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--restore-iter', help='Iteration number to restore.', default=None, type=int)
    parser.add_argument(
        '--restore-model', help='Path to existing model file to restore.', default=None)
    parser.add_argument(
