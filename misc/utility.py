...
def get_es_master(es_algorithm, logger, log_dir,
                  stubs, bucket, experiment_name, credential, start_iter, load_model_path):
...
@gin.configurable
def get_es_worker(es_algorithm, logger, load_model_path, **kwargs):
    ...
    return es_algorithm(logger=logger, load_model_path=load_model_path, **kwargs)
